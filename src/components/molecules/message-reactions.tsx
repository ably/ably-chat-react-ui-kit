...
export const MessageReactions = ({
  ...
  return (
    <div className="ably-message-reactions" role="group" aria-label="Message reactions">
      {emojiNames.map((emoji) => {
        ...
        return (
          <button
            key={emoji}
            className={clsx(
              'ably-message-reactions__button',
              hasUserReacted
                ? 'ably-message-reactions__button--active'
                : 'ably-message-reactions__button--default'
            )}
          ...
          >
            ...
            <span className="ably-message-reactions__count" aria-hidden="true">
              {count}
            </span>
          </button>
        );
