...
const Icon: React.FC<IconProps> = ({
  ...
  const iconPaths: Record<IconName, string> = {
    ...
    emoji:
      'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zM8.5 9A1.5 1.5 0 117 10.5 1.5 1.5 0 018.5 9zM15.5 9a1.5 1.5 0 11-1.5 1.5A1.5 1.5 0 0115.5 9zM8 13h8c0 2.21-1.79 4-4 4s-4-1.79-4-4z',
    thumbsup:
